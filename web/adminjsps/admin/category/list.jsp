...
<style type="text/css">
  ...
  <p style="font-weight: 900; color: red">${msg }</p>
    ...
    <table align="center" border="1" cellpadding="0" cellspacing="0">
    	...
    	<tr bordercolor="rgb(78,78,78)">
    		<td>${categoryItem.cname}</td>
    		<td>
    		  <%--<a href="<c:url value='/adminjsps/admin/category/mod.jsp'/>">修改</a> |--%>
    		  <a href="<c:url value='/adminCategory?method=queryByCid&cid=${categoryItem.cid}'/>">修改</a> |
    		  <%--<a href="<c:url value='/adminjsps/admin/category/del.jsp'/>">删除</a>--%>
    		  <a href="<c:url value='/adminCategory?method=delCategory&cid=${categoryItem.cid}'/>">删除</a>
    		</td>
    	</tr>
		</c:forEach>
